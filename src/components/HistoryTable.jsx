...
const Row = ({ city, history }) => {
  ...
  const sortedHistory = [...history].sort((a, b) => {
    switch (sorting.column) {
      ...
      case "temp":
        return sorting.order === "asc" ? a.temp - b.temp : b.temp - a.temp;
      default:
        return 0;
    }
  });
        ...
        <TableCell style={{ paddingBottom: 0, paddingTop: 0 }} colSpan={6}>
          <Collapse in={open} timeout="auto" unmountOnExit>
            <Box sx={{ margin: 1 }}>
              ...
              <Table size="small" aria-label="weather history">
                <TableHead>
                  <TableRow>
                    <TableCell>
                      <TableSortLabel
                        active={sorting.column === "dateTime"}
                        direction={
                          sorting.column === "dateTime" ? sorting.order : "asc"
                        }
                    ...
                    <TableCell>
                      <TableSortLabel
                        active={sorting.column === "tempMin"}
                        direction={
                          sorting.column === "tempMin" ? sorting.order : "asc"
                        }
                    ...
                    <TableCell>
                      <TableSortLabel
                        active={sorting.column === "tempMax"}
                        direction={
                          sorting.column === "tempMax" ? sorting.order : "asc"
                        }
                    ...
                    <TableCell>
                      <TableSortLabel
                        active={sorting.column === "temp"}
                        direction={
                          sorting.column === "temp" ? sorting.order : "asc"
                        }
              ...
              <Pagination
                count={Math.ceil(sortedHistory.length / itemsPerPage)}
                page={page}
...
const HistoryTable = (weatherHistory) => {
